...
export const Card = () => {
  const [followers, setFollowers] = useState(JSON.parse(localStorage.getItem("followState")).followers);
  const [isFollow, setIsFollow] = useState(JSON.parse(localStorage.getItem("followState")).isFollow)
